(function ($) {
    ...
    /*====== Magnigic Popup Js for Certificates  ======*/
    MIRO.Cgallery = function () {
        var cgallery = $(".certificate-gallery");
        cgallery.magnificPopup({
            type: "image",
            delegate: ".certificate-zoom a",
            closeBtnInside: false,
            closeOnContentClick: true,
            gallery: {
                enabled: true,
    ...
    MIRO.ModeToggle = function () {
        $(".skin_theme").attr("href", "assets/css/skin-3.css");
    };
    ...
    MIRO.Typed1 = function () {
        if ($("#type1")[0]) {
            var element = new Typed("#type1", {
                strings: ["Software Engineer", "Web Designer", "Graphic Designer", "UI/UX Designer"],
                typeSpeed: 100,
                backSpeed: 20,
                loop: true,
            });
    ...
    $(document).ready(function () {
        MIRO.PageScrollEffect(), MIRO.Slider1(), MIRO.Slider2(), MIRO.Slider3(), MIRO.SliderHero(), MIRO.ParticlesOne(), MIRO.ParticlesTwo(), MIRO.ParticlesThree(), MIRO.ParticlesFour(), MIRO.Sidenav(), MIRO.Gallery(), MIRO.Cgallery(), MIRO.DataFilters(), MIRO.Typed(), MIRO.Typed1();
    });
})(jQuery);
